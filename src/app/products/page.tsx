...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  return (
    <section className="relative mx-auto max-w-7xl section-spacing container-padding">
      ...
      <div className="mb-8 max-w-3xl">
        ...
        <p className="mt-4 text-lg leading-8 text-zinc-600">Filter by category, search by name, and build your cart with Robokart&apos;s polished MVP catalog.</p>
      </div>
